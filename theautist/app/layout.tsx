...
export const metadata: Metadata = {
  ...
  description:
    "Personal portfolio showcasing software development projects, AWFixerOS engineering work, and innovative tech solutions. Join the community on Discord.",
  keywords: [
    "developer",
    "portfolio",
    "AWFixerOS",
  ...
  openGraph: {
    ...
    description:
      "Personal portfolio showcasing software development projects, AWFixerOS engineering work, and innovative tech solutions.",
    siteName: "theautist.me",
    images: [
      {
        url: "https://assets.awfixer.com/10.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Personal portfolio showcasing software development projects, AWFixerOS engineering work, and innovative tech solutions.",
    images: ["https://assets.awfixer.com/10.png"],
    creator: "@awfixer",
  },
  robots: {
    index: true,
